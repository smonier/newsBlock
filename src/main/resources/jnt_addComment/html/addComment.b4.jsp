                ...
                <fieldset>
                    ...
                    <p class="field">
                        ...
                        <input class="" value="${sessionScope.formDatas['jcr:title'][0]}"
                               ...
                               tabindex="1" class="form-check-input"/>
                    </p>
                    ...
                    <p class="field">
                        ...
                        <textarea rows="7" cols="35" id="jahia-comment-${boundComponent.identifier}"
                                  name="content"
                                  tabindex="2" class="form-control"><c:if
                    ...
                    <p>
                        <input type="reset" value="<fmt:message key='label.reset'/>" class="btn btn-primary col-3 px-4"
                               tabindex="3"  ${disabled}/>

                        <input type="submit" value="<fmt:message key='label.submit'/>" class="btn btn-primary col-3 px-4"
