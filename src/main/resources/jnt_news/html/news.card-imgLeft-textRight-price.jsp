...
<div class="card mb-3">
    <div class="row no-gutters">
        <div class="col-md-6">
            ...
            <div class="bottom-right"><h5 class="card-text text-primary" style="float:right">IDR ${rand}</h5></div>
        </div>
        <div class="col-md-6">
            <div class="card-body">
                <h5 class="card-text text-primary text-uppercase">${fn:escapeXml(newsTitle.string)}</h5>
