...
<c:choose>
    ...
    <c:otherwise>
        <c:set var="queryFeaturedNewsStatement" value="select * from [jnt:news] as news where ISDESCENDANTNODE(news,'${currentNode.resolveSite.path}') AND news.[featuredNews] = true and news.[j:defaultCategory]='${filter.string}' order by news.[date] desc"/>
    </c:otherwise>
</c:choose>
